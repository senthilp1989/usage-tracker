...
This diagram shows Usage Tracker's internal components, the direction data flows
between them, and how it reaches its one external dependency: **Test Ease**.

## How it connects to Test Ease

Test Ease is the sole ingestion client and the only system Usage Tracker depends
