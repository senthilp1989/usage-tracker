...
| **What each … uses TestEase for** | Customer/environment × feature heatmap with an `Actions` / `% of row` toggle and a **Breadth** column (how many of the four features are used at all)                                                                                                                                                                                                    |
